<?php include "includes/init4.php"; ?>
<?php 
      ...
      <div class="card-body">
       ...
       <br>
              ...
              <div class="text-center p-2">
                ...
                <?php if($detales->states() == 1){ ?>
    <a href="stop.php" class="btn btn-danger btn-icon-split"><span class="icon text-white-50"><i class="fas fa-hand-paper"></i></span>
    <span class="text Font-tajawal">أيقاف أستقبال المشاركات </span>
      </a>
                <?php }else{ ?>
                  <a href="run.php" class="btn btn-primary btn-icon-split"><span class="icon text-white-50"><i class="fas fa-check"></i></span>
    <span class="text Font-tajawal">تشغيل أستقال المشاركات </span>
      </a>
                <?php }?>
   </div>
